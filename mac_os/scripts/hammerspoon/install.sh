...
perl -pi -e "s/config.TV_IP_ADDR = \".*\"/config.TV_IP_ADDR = \"$TV_IP\"/" ~/.hammerspoon/config.lua
perl -pi -e "s/config.TV_MAC_ADDR = \".*\"/config.TV_MAC_ADDR = \"$MAC_ADDRESS\"/" ~/.hammerspoon/config.lua
